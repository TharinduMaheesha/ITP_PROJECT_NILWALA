			...
			<table class="table">
			  ...
			  <c:forEach var="tea" items="${teaDetails}">
			    ...
			    <tr>
			      ...
			      <td><button type="submit" class="btn btn-outline-success" name = "ViewClass" value="view" style = "background-color: green"><b>View</b></button></td>
			     </form>  
			      <td><button type="submit" class="btn btn btn-outline-danger" name = "ViewClass"  value="delete" style = "background-color: red"><b>Delete</b></button></td>
