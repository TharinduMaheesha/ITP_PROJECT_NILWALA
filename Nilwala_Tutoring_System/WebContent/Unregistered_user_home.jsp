...
#Home {background-color: #ff6600;}
#News {background-color: #3366ff;}
...
<button class="tablink" onclick="openPage('Home', this, '#ff6600')" id="defaultOpen">Classes</button>
<button class="tablink" onclick="openPage('News', this, '#3366ff')">News</button>
<button class="tablink" onclick="openPage('Contact', this,'#8c8c8c')">Contact</button>
<button class="tablink" onclick="openPage('About', this, 'orange')">About</button>

<div id="Home" class="tabcontent">
		<div class="jumbotron text-center"style="height: 100px; padding: 10px 20px 50px 20px; color: #ff6600;">
	 		<h2><b>Classes</b></h2>
		</div>
		...
		<div class = "column2" style="height: 500px; width: 30%; float:right;">
			...
			In our system, we cover the areas of 
			in Ordinary level including Science, Mathematics, other main subjects and Biological Science, Physical Science, IT and other main streams 
...
<div id="About" class="tabcontent">
	...
	<div class = "column1" style="height: 500px; width: 65%; float:left;">
		...
		<div class = "column2" style="height: 500px; width: 30%; float:right;">
			...
			children to continue their ordinary and advanced level studies. With help of the talented and experienced teachers,
