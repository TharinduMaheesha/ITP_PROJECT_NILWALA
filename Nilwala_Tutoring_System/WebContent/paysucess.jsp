...
<center><h5 class="text-light bg-dark">Our Other Financial Services for you</h5></center>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <a href="#" class="btn btn-primary" style = "background-color: blue">Check</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="#"  class="btn btn-danger" style = "background-color: blue">Check</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="refundRqst.jsp" class="btn btn-warning" style = "background-color: blue">Claim a refund</a>
      </div>
    </div>
  </div>
