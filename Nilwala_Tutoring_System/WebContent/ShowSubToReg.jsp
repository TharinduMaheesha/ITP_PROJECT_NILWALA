...
<%@ include file="WEB-INF/Teacher_header.jsp" %> 
	...
	<center><table id = sm_tableArea >
				...
				<c:url value = "RegisterConfirm.jsp" var = "RegTeacherSub">
				...
				<tr>
					...
					<td>${sub.name }</td>
					<td>
					<a class="btn btn-success btn-medium"  href="${RegTeacherSub}" role ="button" style = "background-color: green">Register</a>
					</td>
				</tr>
