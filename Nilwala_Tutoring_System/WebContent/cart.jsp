...
<center><input type ="button" name="PAY NOW" value="PAY NOW" class="btn btn-primary" onclick = "window.location.href='totalFee.jsp'" style = "background-color: blue"></center>
<hr >
</body>
</html>