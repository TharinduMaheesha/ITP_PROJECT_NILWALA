...
<input type="hidden" value= <%=value %> name = "modalid">
    <div class="tm_stcontainer">
      <label for="uname" style = "text-align: center ; font-size: 30px"><b>Invalid Key! Check for spellings and try again</b></label>   
    </div>

    <div class="tm_stcontainer" style="background-color:#f1f1f1">
      <button type="button" onclick="history.back()" class="cancelbtn" style = "background-color: #3000b3">Try Again</button>
