	...
	<div class = "tm_class_home">
		...
		<div class = "tm_button_container">
			<div class="tm_btn-group1">
				  ...
				  <button type="submit" name = "appointment" value="notices">Notices</button><br>
				  <button type="submit" name = "appointment" value="myAppointments">My Appointments</button><br>
				  <button type="submit" name = "appointment" value="newAppointment">Add New Appointment</button><br>
