...
<%@ include file="WEB-INF/Admin_header.jsp" %>  
	...
	<div class="row">
	  <div class="col-sm-6">
	    <div class="card">
	      <div class="card-body">
	      	<h4>Search the grade and the medium to remove the subject</h4><br><br>
				...
				<div class="form-group row">
		 		...
		 		<input class="btn btn-danger btn-lg" type="submit" value="Search subjects" style = "background-color : red"><br><br>
		 		</form>
	      </div>
	    </div>
	  </div><br><br>
