	...
	<div class = "tm_class_home">
			  ...
			  <div class="tm_column">
				    <div class="tm_card">
				      ...
				      String iid = (String)request.getAttribute("UserID");
				      	String held = ClassControllerUtil.StudentclassCount(iid);
		...
		<div class = "tm_button_container">
			...
			<input type="hidden" name = "uid" value=<%=iid %>>
				  <button type="submit" name = "StudentClass" value="available">New Classes</button><br>
				  <button type="submit" name = "StudentClass" value="View Enrolled Classes">Enrolled Classes</button><br>
